...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white/90 backdrop-blur-sm overflow-hidden border-t-2 border-slate-200">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-teal-200/10 to-emerald-200/10 rounded-full blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed font-medium">
              CTO & Solution Architect specializing in enterprise solutions, AI integration, and Drupal development.
            </p>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-slate-600 font-semibold">
                <FontAwesomeIcon icon={faEnvelope} className="w-4 h-4 text-cyan-500" />
                <a href="mailto:hello@digidrop.io" className="hover:text-blue-600 transition-colors">
                  hello@digidrop.io
                </a>
              </div>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-bold mb-4 text-slate-800">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="group inline-flex items-center gap-2 text-slate-600 hover:text-blue-600 transition-colors duration-200 font-semibold"
                  >
            ...
            <div className="mt-6 pt-6 border-t border-slate-200">
              <Link
                ...
                className="inline-flex items-center gap-2 text-slate-600 hover:text-emerald-600 transition-colors font-bold"
              >
                <span>Digidrop Ltd</span>
                <span className="text-slate-400">→</span>
              </Link>
              <p className="text-sm text-slate-500 mt-1">Digital Solutions & Innovation</p>
            </div>
          </div>

          {/* Social Links */}
          <div>
            <h4 className="text-xl font-bold mb-4 text-slate-800">Connect With Me</h4>
            <div className="grid grid-cols-2 gap-3 mb-6">
              {socialLinks.map((link) => (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group flex items-center gap-3 p-4 bg-white rounded-xl border-2 border-slate-200 hover:border-transparent hover:shadow-lg transition-all duration-300 hover:scale-105`}
                >
        ...
        <div className="pt-8 border-t-2 border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-600 font-medium">
              ...
              <span>•</span>
              <span className="font-bold text-cyan-600">TypeScript</span>
              <span>•</span>
              <span className="font-bold text-teal-600">Tailwind CSS</span>
            </div>
          </div>
        </div>
      </div>
