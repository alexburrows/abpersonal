  ...
  const services = [
    {
      ...
      description: "Strategic technical leadership for your organization. I provide hands-on CTO expertise to guide technology decisions, build teams, and drive innovation.",
      icon: faUsers,
    ...
    },
    {
      ...
      description: "Full-stack development services for complex enterprise applications. Specializing in TypeScript, React, Next.js, Node.js, and Drupal.",
      icon: faCode,
      points: ["Custom Web Apps", "API Development", "Drupal Solutions", "Performance Optimization"]
    },
    {
    ...
    <section data-parallax-section className="py-20 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-4 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
            Why Work With Me?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {services.map((service) => (
            <div
              key={service.title}
              className="group relative bg-white p-8 rounded-2xl border-2 border-slate-200 hover:border-emerald-500 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-100 to-teal-100 opacity-0 group-hover:opacity-100 rounded-full blur-2xl transition-all duration-300"></div>
                ...
                <div className="space-y-2">
                  {service.points.map((point) => (
                    <div key={point} className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-700 font-semibold">{point}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* CTA Box */}
        <div className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 p-10 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white text-emerald-600 rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 font-bold"
            >
